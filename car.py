...
#@st.cache_resource  # Caches the model so it's not reloaded every time the app reruns
def load_model():
    return joblib.load(r"C:\Users\91976\car_LinearRegressionModel.pkl")
...
#st.image("C:\Users\91976\Downloads\car_img\car_img.png", caption="Car Image", use_column_width=True)
...
car_name = st.selectbox("Car name", ['Hyundai Santro Xing', 'Mahindra Jeep CL550', 'Hyundai Grand i10',
...
year = st.number_input("Year", min_value=1990, max_value=2024, value=2019)
kms_driven = st.number_input("Kilometers Driven (in thousands)", value=100)
...
if st.button("Predict Price"):
    ...
    prediction = pipe.predict(input_data)[0]  # Get the predicted value
